...
def pcd_from_midas(img: np.ndarray) -> o3d.geometry.PointCloud:
    ...
    ################################################################################################################################################
    return depth_midas_norm, pcd_midas

if __name__ == "__main__":
    """ DO NOT CHANGE ANYTHING HERE """
    stereo_depth, stereo_pcd = pcd_from_stereo(
    ...
    midas_depth, midas_pcd = pcd_from_midas(cv.imread("data/im0.png"))
